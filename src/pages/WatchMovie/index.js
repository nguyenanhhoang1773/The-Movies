      ...
      <div className=" mt-[50px] mb:flex mb:justify-center mb:flex-col mb:mt-[30px] ">
        ...
        {!movie.title && (
          <div>
            ...
            <p className="w-[1000px] mb:w-[300px] mt-[12px]">
              {!isMoblie && (
                <span className="text-[10px] font-[500] text-slate-500  bg-slate-500 mr-[4px]">
                  ...
                  minhf uoc gi anh ay la nguoi yeu cua minh hoang la nguoi vua
                  dep trai vua tot bung anh ay qua la dinh minhf uoc gi anh ay
                  la nguoi yeu cua minh uoc gi anh ay la nguoi yeu cua minhla
                  nguoi vua dep trai vua tot bung anh ay qua la dinh minhf uoc
                  gi anh ay la nguoi yeu cua minh uoc gi anh ay la nguoi yeu cua
                  minhla nguoi vua dep trai vua tot bung anh ay qua la dinh
                  minhf uoc gi anh ay la nguoi yeu cua minh uoc gi anh ay la
                </span>
              )}
              {isMoblie && (
                <span className="text-[10px] font-[500] text-slate-500  bg-slate-500 mr-[4px]">
